          ...
          {isLoaded ? (
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-1">
                <button
                  className={`text-sm ${i18n.language === "id" ? "font-bold" : ""}`}
                  onClick={() => changeLang("id")}
                >
                  ID
                </button>
                <button
                  className={`text-sm ${i18n.language === "en" ? "font-bold" : ""}`}
                ...
                <div className="md:hidden">
                  <Sheet>
                    ...
                    <SheetContent side="left" className="pt-10 flex flex-col space-y-4 neumorphic-bg">
                      <Link to="/dashboard" className="neumorphic-button-sm w-full text-left">{t('navbar.dashboard')}</Link>
                      <Link to="/forum" className="neumorphic-button-sm w-full text-left">{t('navbar.forum')}</Link>
                      <Link to="/marketplace" className="neumorphic-button-sm w-full text-left">{t('navbar.marketplace')}</Link>
                      <Link to="/kursus" className="neumorphic-button-sm w-full text-left">{t('navbar.kursus')}</Link>
                      <Link to="/polling" className="neumorphic-button-sm w-full text-left">{t('navbar.polling')}</Link>
                      <Link to="/faq" className="neumorphic-button-sm w-full text-left">{t('navbar.faq')}</Link>
                      <Link to="/profile" className="neumorphic-button-sm w-full text-left">{t('navbar.profile')}</Link>
                      <UserButton
                        afterSignOutUrl="/"
                        appearance={{
                          elements: {
              ...
              <Unauthenticated>
                ...
                <div className="md:hidden">
                  <Sheet>
                    ...
                    <SheetContent side="left" className="pt-10 flex flex-col space-y-4 neumorphic-bg">
                      <Link to="/login" className="neumorphic-button-sm w-full text-left">{t('navbar.login')}</Link>
                      <Link to="/forum" className="neumorphic-button-sm w-full text-left">{t('navbar.forum')}</Link>
