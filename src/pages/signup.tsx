...
export default function Signup() {
  ...
  // Handle user session creation after successful signup
  useEffect(() => {
        ...
        <div className="w-full max-w-md">
          <div className="neumorphic-card p-8 mb-6">
            <div className="text-center mb-6">
              ...
              <p className="text-[#86868B]">
                Bergabunglah dengan komunitas parfum enthusiast kami.
              </p>
            </div>
            <SignUp
              path="/signup"
          ...
          <div className="text-center">
            <p className="text-sm text-[#86868B]">
              ...
              <a
                href="/login"
                className="text-[#667eea] hover:text-[#5a67d8] transition-colors font-medium"
              >
                Masuk di sini
              </a>
            </p>
